...
$folder:=$homeFolder.folder("granite-embedding-278m-multilingual")
$path:="granite-embedding-278m-multilingual-onnx-int8"
$URL:="keisuke-miyako/granite-embedding-278m-multilingual-onnx-int8"
...
$folder:=$homeFolder.folder("granite-embedding-278m-multilingual")
$path:="granite-embedding-278m-multilingual-ct2-int8"
$URL:="keisuke-miyako/granite-embedding-278m-multilingual-ct2-int8"
